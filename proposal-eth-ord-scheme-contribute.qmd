...
- RQ2.2: What are the practical difficulties of transferring a Stata script into a set of R scripts that achieve the same results?
...
We will use our established networks and communities to disseminate the developed products. The process can tightly fit into our openwashdata project, funded under the ETH ORD Scheme for Explore Projects and starting March 1st, 2023. The packages will provide a neat opportunity to prepare novel teaching material that motivates WASH professionals and at the same time disseminates our products. 
